...
@app.route('/set/<string:key_id>', methods=['POST']) #GET requests will be blocked
def json_set(key_id):
    global R
    req_data = request.get_json()
    out = R.set(key_id, dumps(req_data))
    return dumps(out)
...
if __name__ == '__main__':
    ...
    #api.add_resource(SetKeyPost, '/set')
